module Pesapal
  # Contains helper methods relating to any queries for payment status.
  module Status
    # Prepares parameters to be used during the QueryPaymentStatusByMerchantRef oAuth 1.0 call.
    #
